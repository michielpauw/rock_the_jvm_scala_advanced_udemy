...
object DarkSugars extends App {
  ...
  // Compiler doesn't rewrite as 2.::(List(3, 4)) as expected, but as
  // List(3, 4).::(2)
  // ?
  ...
  */
  ...
  class Mutable {
    ...
    private var otherMember: Int = 5
    def member = internalMember // getter
    def member_=(value: Int): Unit = internalMember = value
    def other = otherMember
    def other_=(value: Int): Unit = otherMember = value
  }
  val aMutableContainer = new Mutable
  aMutableContainer.member = 42 // rewritten as aMutableContainer.member_=(42)
  println(aMutableContainer.member)
  aMutableContainer.other = 80
  println(aMutableContainer.other)
}
